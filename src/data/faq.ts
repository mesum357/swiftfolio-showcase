...
const faq: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Yes. Mesum Abbas is a Full Stack Developer in Pakistan available for remote freelance and full-time work. He builds SaaS products, MVPs, and custom web apps for clients nationwide and internationally.',
  },
  {
    question: 'Do you build SaaS products?',
    answer:
      'Yes. As a SaaS developer, Mesum Abbas designs and builds multi-tenant SaaS applications, dashboards, APIs, and subscription-ready platforms using React, Node.js, and cloud infrastructure.',
  },
  {
    question: 'Do you offer MVP development for startups?',
    answer:
      'Yes. As an MVP developer, Mesum Abbas helps founders ship a launchable product quickly — scoped features, clean UI, and a production stack so you can validate with real users instead of throwaway prototypes.',
  },
  {
